...
// Generated on Sun, 17 Sep 2023 19:48:19 GMT
...
public class StyleDictionaryClass {
    ...
    public static let globalColorAlertBg = UIColor(argb: 0xFF4A4A)
    ...
    public static let globalColorLabelSecondary = UIColor(argb: 0x2F2F2F)
    public static let globalColorLabelSubtitle = UIColor(argb: 0x2F2F2F)
    public static let globalColorPrimary = UIColor(rgb: 0x0C6DFF)
    public static let globalColorShadowBlue = UIColor(argb: 0x0C6DFF)
    public static let globalColorShadowGray = UIColor(argb: 0x000000)

...
// Generated on Sun, 17 Sep 2023 19:35:42 GMT
...
public class StyleDictionaryClass {
    ...
    public static let globalColorAlertBg = UIColor(argb: 0xFF4A4A30)
    ...
    public static let globalColorLabelSecondary = UIColor(argb: 0x2F2F2F99)
    public static let globalColorLabelSubtitle = UIColor(argb: 0x2F2F2F61)
    public static let globalColorPrimary = UIColor(rgb: 0x0C6DFF)
    public static let globalColorShadowBlue = UIColor(argb: 0x0C6DFF80)
    public static let globalColorShadowGray = UIColor(argb: 0x00000040)
    ...
    public static let globalShadowBlue = TokenShadow(
      ...
      blur: 16,
      color: UIColor(rgb: 0x0C6DFF80),
      shadowOpactity: 0.25
    )
    public static let globalShadowGray = TokenShadow(
      offset: CGSize(width: 0, height: 4),
      blur: 16,
      color: UIColor(rgb: 0x00000080),
      shadowOpactity: 0.25
    )
